...
from Project.app import ACTIVITY_CSV_FILE
from Project.plotter import plot_eda_scatter_base64, plot_eda_box_base64
...
# (Thêm khối này vào gần đầu file app.py của bạn)
