...
CREATE TABLE `ml_model` (
  ...
  `status` enum('Active','Deprecated') DEFAULT NULL,
...
INSERT INTO `ml_model` VALUES (1,'XGBoost Default','Mô hình phân loại Churn mặc định','2025-10-28','Active'),(2,'XGBoost Default','Mô hình phân loại Churn mặc định','2025-10-28','Active');
