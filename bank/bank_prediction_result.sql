...
CREATE TABLE `prediction_result` (
  ...
  `segment` enum('High risk','Medium risk','Low risk') DEFAULT NULL,
  PRIMARY KEY (`prediction_id`),
  KEY `customer_id` (`customer_id`),
  KEY `run_id` (`run_id`),
  CONSTRAINT `prediction_result_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`),
  CONSTRAINT `prediction_result_ibfk_2` FOREIGN KEY (`run_id`) REFERENCES `training_run` (`run_id`)
